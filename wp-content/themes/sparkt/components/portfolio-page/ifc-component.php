<div class="c-ifc">
    <div class="c-ifc__wrapper">
        <div class="c-ifc__wrapper-text">
            <h1 class="c-ifc__headline u-detect-to-hide">IFC</h1>
            <h3 class="c-ifc__description u-detect-to-hide">Octo U Customization for a Canadian Insurance Company</h3>
            <p class="c-ifc__headline--small u-detect-to-hide">Challenge</p>
            <p class="c-ifc__text u-detect-to-hide">
            ...
            <p class="c-ifc__headline--small u-detect-to-hide">Solution</p>
            <p class="c-ifc__text u-detect-to-hide">
        ...
        <div class="c-ifc__sidebar">
            <div class="c-ifc__img u-detect-to-hide" data-img style="background-image: url('<?php echo get_template_directory_uri() ?>/public/images/ifc-photo.jpg')"></div>
            <p class="c-ifc__headline--small u-detect-to-hide">Tools used:</p>
            <p class="c-ifc__headline-tools-describe u-detect-to-hide">Core system:</p>
            <ul class="c-ifc__wrapper-tools u-detect-to-hide">
            ...
            <p class="c-ifc__headline-tools-describe u-detect-to-hide">Monitoring:</p>
            <ul class="c-ifc__wrapper-tools u-detect-to-hide">
                <li class="c-ifc__tools-item">Elasticsearch</li>
                <li class="c-ifc__tools-item">Kibana</li>
            </ul>
            <p class="c-ifc__headline--small u-detect-to-hide">June 2016 - December 2016, currently in maintenance.</p>
        </div>
    </div>
</div>