<div class="c-octou" data-project>
    <div class="c-octou__wrapper">
        <div class="c-octou__wrapper-text" data-wrapper-text>
            <h1 class="c-octou__headline u-detect-to-hide">OctoU</h1>
            <h3 class="c-octou__description u-detect-to-hide">System for Analyzing Driving Behavior of Users</h3>
            <p class="c-octou__headline--small u-detect-to-hide">Challenge</p>
            <p class="c-octou__text u-detect-to-hide">Our client- Octo Telematics - sought to build a powerful platform to evaluate driving behavior of users based on data collected by mobile applications. They had only a high-level vision of the product with no specific functional requirements and no clear expectations as to number of users or amount of data each user will generate.
            ...
            <p class="c-octou__headline--small u-detect-to-hide">Solution</p>
            <p class="c-octou__text u-detect-to-hide">
        ...
        <div class="c-octou__sidebar">
            <div class="c-octou__img u-detect-to-hide" data-img style="background-image: url('<?php echo get_template_directory_uri() ?>/public/images/octou-photo.png')"></div>
            <p class="c-octou__headline--small u-detect-to-hide">Tools used:</p>
            <p class="c-octou__headline-tools-describe u-detect-to-hide">Core system:</p>
            <ul class="c-octou__wrapper-tools u-detect-to-hide">
            ...
            <p class="c-octou__headline-tools-describe u-detect-to-hide">Web console:</p>
            <ul class="c-octou__wrapper-tools u-detect-to-hide">
                <li class="c-octou__tools-item">Angular 5</li>
                <li class="c-octou__tools-item">TypeScript</li>
            </ul>
            <p class="c-octou__headline--small u-detect-to-hide">June 2014 - still being developed.</p>
        </div>
    </div>
</div>