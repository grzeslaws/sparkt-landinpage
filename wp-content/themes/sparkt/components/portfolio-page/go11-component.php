<div class="c-go11">
    <div class="c-go11__wrapper">
        <div class="c-go11__wrapper-text">
            <h1 class="c-go11__headline">go11</h1>
            <h3 class="c-go11__description">System for Insurance companies to provide UBI to customers</h3>
            <p class="c-go11__headline--small">Challenge</p>
            <p class="c-go11__text">
            ...
            <p class="c-go11__headline--small">Solution</p>
            <p class="c-go11__text">
        ...
        <div class="c-go11__sidebar">
            <div class="c-go11__img" data-img style="background-image: url('<?php echo get_template_directory_uri() ?>/public/images/go11-photo.jpg')"></div>
            <p class="c-go11__headline--small">Tools used:</p>
            <ul class="c-go11__wrapper-tools">
                <li class="c-go11__tools-item">Backend: Java 8, Spring Boot, ActiveMQ, MySQL, Cassandra</li>
            </ul>
            <ul class="c-go11__wrapper-tools">
                <li class="c-go11__tools-item">Web Application: Angular 2</li>
            </ul>
            <ul class="c-go11__wrapper-tools">
                <li class="c-go11__tools-item">Android: Java, Android SDK, Gradle</li>
            </ul>
            <ul class="c-go11__wrapper-tools">
                <li class="c-go11__tools-item">iOS: Swift 4, CocoaPods, PromiseKit</li>
            </ul>
            <ul class="c-go11__wrapper-tools">
                <li class="c-go11__tools-item">Monitoring: 
                Influxdata TICK, Crashlytics, AWS EC2, Jenkins, Ansible, fastlane</li>
            </ul>
            <p class="c-go11__headline--small">June 2017 - still being developed, 
