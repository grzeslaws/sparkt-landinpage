<div class="c-contact-us">
    <div class="c-contact-us__wrapper">
        <h1 class="c-contact-us__headline">Contact us</h1>
        <p class="c-contact-us__description">Want to learn more? Contact us.</p>
        <form class="o-form c-contact-us__form">
            <input class="o-form__input" type="text" placeholder="Name*">
            <div class="o-form__wrapper-inputs">
                <input class="o-form__input" type="text" placeholder="E-mail*">
                <input class="o-form__input" type="text" placeholder="Phone">
            </div>
